        ...
        <View style={[styles.card, { marginTop: 20 }]}>
          ...
          <View style={{ marginBottom: 20 }}>
            ...
            <View style={{ marginBottom: 12 }}>
              <Text style={[styles.textSecondary, { fontSize: 14, marginBottom: 4 }]}>{t('wab_url')}</Text>
              <View
                style={[
                  styles.row,
                  {
            ...
            {/* Wallet Storage URL */}
            <View style={{ marginBottom: 12 }}>
              <Text style={[styles.textSecondary, { fontSize: 14, marginBottom: 4 }]}>{t('wallet_storage_url')}</Text>
              <View
                style={[
                  styles.row,
                  {
            ...
            {/* NETWORK */}
            <View style={{ marginBottom: 12 }}>
              <Text style={[styles.textSecondary, { fontSize: 14, marginBottom: 4 }]}>{t('bsv_network')}</Text>
              <View
                style={[
                  styles.row,
                  {

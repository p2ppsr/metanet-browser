...
const BottomToolbar = ({
  ...
  const handlePersonPress = useCallback(() => {
    // If not in web3 mode or wallet manager isn't set, navigate to metanet route
    if (isWeb2Mode || !managers?.walletManager?.authenticated) {
      router.push('/metanet')
    } else {
      // Otherwise open the info drawer as usual
      toggleInfoDrawer(true)
    }
  }, [isWeb2Mode, managers?.walletManager?.authenticated, toggleInfoDrawer])
  ...
  return (
    ...
    >
      <TouchableOpacity onPress={handlePersonPress} style={styles.toolbarButton}>

...
(function() {
  ...
  window.__metanetDeniedPermissions = Array.isArray(denied) ? denied : (denied ? [denied] : []);
  window.__metanetPendingPermissions = Array.isArray(pending) ? pending : (pending ? [pending] : []);
